...
/**
 * Clase PageObject que contiene los target de la pagina del producto
 * seleccionado por el actor
 * 
...
public class AlkomprarProductPage extends PageObject {
	...
	public static final Target ADDS_TO_SHOPPING_CAR_HEADER = Target.the("adds to shopping car header")
			.located(By.id("Addtocart_header"));
